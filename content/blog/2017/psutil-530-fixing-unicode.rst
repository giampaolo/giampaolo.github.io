...
psutil has different APIs returning a string, many of which misbehaved when it came to unicode. There were three distinctive problems (`#1040 <https://github.com/giampaolo/psutil/issues/1040>`__). Each API could:
