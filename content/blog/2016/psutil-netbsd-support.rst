...
The NetBSD implementation has similar limitations to the ones I encountered with OpenBSD. Again, FreeBSD presents itself as the BSD variant with the best support in terms of kernel functionalities.
...
You can read the rest in the `HISTORY <https://psutil.readthedocs.io/latest/changelog.html>`_ file, as usual.
